...
export default function UserProfile() {
    ...
    useEffect(() => {
        ...
        const fetchOfficersDetail = async () => {
            ...
            try {
                const apiOfficersUrl = `${baseUrl}users/${userId}`;
                ...
                console.error(`Error fetching Officers ${userId}:`, err);
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const apiUserUrl = `${baseUrl}users/${userId}`;
                ...
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                    <section className="w-full overflow-hidden dark:bg-gray-900">
                        <div className="flex flex-col">
                            {/* Cover image */}
                            <img src="https://images.unsplash.com/photo-1749920937484-a61e6a9566a9?q=80&w=1229&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                alt="User Cover"
                                className="w-full xl:h-[20rem] lg:h-[18rem] md:h-[16rem] sm:h-[14rem] h-[11rem] object-cover rounded-t-lg" />

                            <div className="w-full px-4 sm:px-6 flex flex-col sm:flex-row items-center relative lg:bottom-[5rem] sm:bottom-[4rem] bottom-[3rem]">
                                {/* Profile picture */}
                            ...
                            <div className="w-full px-4 sm:px-6 flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 -top-4">
                                ...
                                <form onSubmit={handleSubmit} className="w-full">
                                    <div className="w-full my-auto py-6 flex flex-col justify-center gap-2">
                                        <div className="w-full flex sm:flex-row flex-col gap-2 justify-center">
                                            ...
                                            {/* Other Static Details (Right Column) */}
                                            <div className="w-full">
                                                <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                                                    {/* Profile Picture Upload Field (only in Dev Mode) */}
                                                    {isDevMode && (
                                                        <div className="flex flex-col pb-3">
                                        ...
                                        {/* Submit Button (only visible in Dev Mode) */}
                                        {isDevMode && (
