...
export default function KelolaLaporanKehilangan() {
    ...
    const currentItems = slkData.slice(indexOfFirstItem, indexOfLastItem);
    const totalPages = Math.ceil(slkData.length / itemsPerPage);
    ...
    useEffect(() => {
        if (!slkData) {
            setError("Laporan Kehilangan not found in URL.");
            setLoading(false);
            return;
        }
                ...
                <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                    <div className="mx-auto max-w-5xl">
                        <div className="gap-4 sm:flex sm:items-center sm:justify-between">
                            <h2 className="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">List Pemohon Laporan Kehilangan</h2>
                                    ...
                                    <div className="flex flex-wrap items-center gap-y-4 py-6">
                                        <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                                            ...
                                            <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
                                                <a href="#" className="hover:underline">{slk.id}</a>
                                            </dd>
                                        </dl>
                                        ...
                                        <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                                            ...
                                            <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">{new Date(slk.date_lost).toLocaleDateString()}</dd>
                                        </dl>
