...
export default function Dashboard(){
    ...
    return (
        <main className="lg:ml-[260px] pt-4 py-4 px-6 grid grid-rows-2 md:grid-cols-2 gap-4 over">
            ...
            <Link href="/admin/layanan/laporan_kehilangan" className="border-b-3 rounded-xl bg-yellow-100 dark:bg-gray-800 border-sky-400 p-4 text-gray-800 dark:text-white font-bold grid grid-cols-2 gap-4 h-40 md:h-48">
            ...
            <Link href="/admin/layanan/pengaduan" className="border-b-3 rounded-xl bg-yellow-100 dark:bg-gray-800 border-yellow-400 p-4 text-gray-800 dark:text-white font-bold grid grid-cols-2 gap-4 h-40 md:h-48">
              <div className="pl-2 md:pl-4 pt-2 md:pt-4 text-sm md:text-base">
