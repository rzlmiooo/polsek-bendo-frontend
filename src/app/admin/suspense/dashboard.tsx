...
export default function Dashboard(){
        ...
        const fetchNewSkck = async () => {
          try {
            ...
            const pendingPm = allPm.filter(
              (b:any) =>
                b.complaint_status === "diterima" || b.complaint_status === "dipending" &&
                users.filter((user:any) => user.id === b.user_id)
            );
    ...
    return (
        <main className="lg:ml-[260px] pt-4 py-4 px-6 grid grid-rows-2 md:grid-cols-2 gap-4">
            ...
            <Link href="/admin/layanan/skck" className="border-b-3 rounded-xl bg-yellow-100 dark:bg-gray-800 border-green-400 p-4 text-gray-800 dark:text-white font-bold grid grid-cols-2 gap-4 h-48">
              <div className="pt-4 pl-4">
                Permintaan SKCK
              </div>
              <div className="p-4 row-span-2 flex gap-6 justify-evenly">
                <span className="text-9xl">{countSKCK}</span>
                <svg
            ...
            <Link href="/admin/layanan/izin_keramaian" className="border-b-3 rounded-xl bg-yellow-100 dark:bg-gray-800 border-red-400 p-4 text-gray-800 dark:text-white font-bold grid grid-cols-2 gap-4 h-48">
              <div className="pt-4 pl-4">
                Permintaan Surat Izin Keramaian
              </div>
              <div className="p-4 row-span-2 flex gap-6 justify-evenly">
              <span className="text-9xl">{countSIK}</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <Link href="/admin/layanan/pengaduan" className="border-b-3 rounded-xl bg-yellow-100 dark:bg-gray-800 border-yellow-400 p-4 text-gray-800 dark:text-white font-bold grid grid-cols-2 gap-4 h-48">
              <div className="pl-4 pt-4">
                Permintaan Surat Laporan Kehilangan
              </div>
              <div className="p-4 row-span-2 flex gap-6 justify-evenly">
              <span className="text-9xl">{countSLK}</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
