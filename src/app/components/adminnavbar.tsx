            ...
            <div className="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
              <nav className="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                <ul className="flex flex-col space-y-1">
                  ...
                  <li><Link className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-white rounded-lg hover:bg-gray-100 hover:text-gray-900 focus:outline-hidden focus:bg-gray-100" href="/admin/articles">
                    <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2" /><line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /><path d="M8 14h.01" /><path d="M12 14h.01" /><path d="M16 14h.01" /><path d="M8 18h.01" /><path d="M12 18h.01" /><path d="M16 18h.01" /></svg>
                    Artikel
                  </Link></li>
                  <li><Link className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-white rounded-lg hover:bg-gray-100 hover:text-gray-900 focus:outline-hidden focus:bg-gray-100" href="/admin/structure">
                  ...
                  <li><Link className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-white rounded-lg hover:bg-gray-100 hover:text-gray-900 focus:outline-hidden focus:bg-gray-100" href="/admin/layanan/skck">
                  ...
                  <li><Link className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-white rounded-lg hover:bg-gray-100 hover:text-gray-900 focus:outline-hidden focus:bg-gray-100" href="/admin/layanan/izin_keramaian">
                  ...
                  <li><Link className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-white rounded-lg hover:bg-gray-100 hover:text-gray-900 focus:outline-hidden focus:bg-gray-100" href="/admin/layanan/laporan_kehilangan">
                  ...
                  <li><Link className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-white rounded-lg hover:bg-gray-100 hover:text-gray-900 focus:outline-hidden focus:bg-gray-100" href="/admin/layanan/pengaduan">
