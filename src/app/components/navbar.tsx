        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div
            className={`fixed top-0 left-0 w-full bg-white transform transition-transform duration-300 ease-in-out
              ${isOpen ? "translate-y-0 top-18" : "-translate-y-full"}
              md:static md:w-auto flex flex-col md:flex-row items-center md:translate-y-0`}
          >
            <ul className="flex flex-col items-center md:flex-row md:space-x-8 md:pr-4 w-full">
              <li>
            ...
            {/* Order Icon */}
            <div className="flex justify-center mt-4 md:mt-0 mb-4 md:mb-0">
              {!token && (
              <Link href="/login" className="flex justify-center gap-2 items-center py-2 px-6 hover:text-[#996515] rounded border-l-0 md:border-l-1 md:border-black">
              ...
              {token && (
              <a href="/order" className="flex justify-center gap-2 items-center py-2 px-6 hover:text-[#996515] rounded border-l-0 md:border-l-1 md:border-black">
                <h2 className="font-bold">Login</h2>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
